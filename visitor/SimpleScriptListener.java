...
public interface SimpleScriptListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SimpleScriptParser#nestedArray}.
	 * @param ctx the parse tree
	 */
	void enterNestedArray(SimpleScriptParser.NestedArrayContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleScriptParser#nestedArray}.
	 * @param ctx the parse tree
	 */
	void exitNestedArray(SimpleScriptParser.NestedArrayContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SimpleScriptParser#caseClause}.
	 * @param ctx the parse tree
	 */
	void enterCaseClause(SimpleScriptParser.CaseClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleScriptParser#caseClause}.
	 * @param ctx the parse tree
	 */
	void exitCaseClause(SimpleScriptParser.CaseClauseContext ctx);
	/**
	 * Enter a parse tree produced by {@link SimpleScriptParser#defaultClause}.
	 * @param ctx the parse tree
	 */
	void enterDefaultClause(SimpleScriptParser.DefaultClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleScriptParser#defaultClause}.
	 * @param ctx the parse tree
	 */
	void exitDefaultClause(SimpleScriptParser.DefaultClauseContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SimpleScriptParser#str}.
	 * @param ctx the parse tree
	 */
	void enterStr(SimpleScriptParser.StrContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleScriptParser#str}.
	 * @param ctx the parse tree
	 */
	void exitStr(SimpleScriptParser.StrContext ctx);
}